...
goimports: FORCE install-goimports
	@printf "\e[1;36m>> goimports -w -local https://github.com/SAP-cloud-infrastructure/maia\e[0m\n"
	@goimports -w -local github.com/SAP-cloud-infrastructure/maia $(patsubst $(shell awk '$$1 == "module" {print $$2}' go.mod)%,.%/*.go,$(shell go list ./...))
